...
> Terrace is a cross-platform Flutter LLM chat client (Android / iOS / macOS / Windows / Linux).
...
- The following are generated or build artifacts. Never hand-edit them:
  ...
  - `.dart_tool/**`
  - `build/**`
- The package name is `Terrace`. Existing imports use `package:Terrace/...` everywhere. Do not "normalize" the package name.
