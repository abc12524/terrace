...
struct GenerationActivityExtensionBundle: WidgetBundle {
  var body: some Widget {
    TerraceGenerationActivityWidget()
  }
}

struct TerraceGenerationActivityWidget: Widget {
  var body: some WidgetConfiguration {
    ActivityConfiguration(for: TerraceGenerationActivityAttributes.self) { context in
...
private struct LockScreenLiveActivityView: View {
  let context: ActivityViewContext<TerraceGenerationActivityAttributes>
