...
import 'package:Terrace/core/services/search/providers/grok_search_service.dart';
...
void main() {
  group('Grok search service', () {
    ...
    test('posts responses request and parses distinct url citations', () async {
              ...
              'output': [
                {'type': 'web_search_call', 'status': 'completed'},
                {
                  ...
                  'content': [
                    {
                      'type': 'output_text',
                      'text': 'Terrace is a Flutter chat client.',
                      'annotations': [
                        {
                          'type': 'url_citation',
      ...
      expect(result.answer, 'Terrace is a Flutter chat client.');
