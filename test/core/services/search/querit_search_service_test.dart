...
import 'package:Terrace/core/services/search/providers/querit_search_service.dart';
import 'package:Terrace/core/services/search/search_service.dart';
import 'package:Terrace/utils/brand_assets.dart';
...
void main() {
  group('Querit search service', () {
    ...
    test('posts filters and parses Querit results', () async {
      ...
      expect(result.items.single.title, 'Terrace');
      expect(result.items.single.url, 'https://example.com/terrace');
      expect(
    ...
    test('omits filters when optional values are empty', () async {
      ...
      expect(jsonDecode(captured!.body), {'query': 'terrace', 'count': 5});
    ...
    test('parses sentence field when snippets are absent', () async {
      ...
      expect(result.items.single.title, 'https://example.com/terrace');
