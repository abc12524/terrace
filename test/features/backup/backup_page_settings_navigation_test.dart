...
import 'package:Terrace/core/providers/backup_provider.dart';
import 'package:Terrace/core/providers/backup_reminder_provider.dart';
import 'package:Terrace/core/providers/s3_backup_provider.dart';
import 'package:Terrace/core/providers/settings_provider.dart';
import 'package:Terrace/core/services/chat/chat_service.dart';
import 'package:Terrace/desktop/setting/backup_pane.dart';
import 'package:Terrace/features/backup/pages/backup_page.dart';
...
void main() {
  ...
  group('BackupPage mobile backup settings navigation', () {
    ...
    testWidgets('opens WebDAV settings as a full page and saves config', (
      ...
      await tester.enterText(fields.at(4), ' TerraceTest/1.0 ');
      ...
      expect(settings.webDavConfig.userAgent, 'TerraceTest/1.0');
    });
