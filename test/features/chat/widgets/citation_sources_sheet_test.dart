...
import 'package:Terrace/features/chat/widgets/citation_sources_sheet.dart';
...
void main() {
  testWidgets(
    ...
    (tester) async {
      ...
      expect(find.text('Terrace release notes'), findsOneWidget);
      expect(
