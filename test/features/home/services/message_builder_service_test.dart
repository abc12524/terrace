...
import 'package:Terrace/core/models/conversation.dart';
import 'package:Terrace/core/services/chat/chat_service.dart';
import 'package:Terrace/features/home/services/message_builder_service.dart';
...
void main() {
  ...
  group('MessageBuilderService.buildApiMessages', () {
    ...
    test('工具历史会保留 provider 元数据供 Claude 和 Gemini 重放', () {
      ...
      final apiMessages = service.buildApiMessages(
        messages: [
          _message(id: 'u1', role: 'user', content: '查 Terrace'),
